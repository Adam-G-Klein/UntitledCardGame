        ...
        IFXExperienceClip
{
    ...
    public override Playable CreatePlayable(PlayableGraph graph, GameObject owner)
    {
        ...
        ScriptPlayable<PartialTweenBehaviour> playable = ScriptPlayable<PartialTweenBehaviour>.Create(graph);
        PartialTweenBehaviour tween = playable.GetBehaviour();
