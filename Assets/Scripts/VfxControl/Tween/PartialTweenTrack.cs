...
[TrackClipType(typeof(PartialTweenClip))]
public class PartialTweenTrack : TrackAsset
{
    ...
    {
        return ScriptPlayable<PartialTweenMixerBehaviour>.Create(graph, inputCount);
    }
}