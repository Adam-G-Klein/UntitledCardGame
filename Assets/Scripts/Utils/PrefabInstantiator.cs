...
public static class PrefabInstantiator {
    ...
    public static PlayableCard instantiateCard(GameObject cardPrefab, Transform parent, CardInfo card, CombatEntityInEncounterStats companionFromStats){
        ...
        cardPlayable.setCompanionFrom(companionFromStats);
        return cardPlayable;
    }
}