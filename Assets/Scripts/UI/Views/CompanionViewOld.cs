...
public class CompanionViewOld : IUIEventReceiver
{
    ...
    public static CompanionViewContextOld COMBAT_CONTEXT =
        new CompanionViewContextOld(true, false, true, true, false, false, false, false, 1.25f, 0.175f);

    public static CompanionViewContextOld COMBAT_CONTEXT_VISUAL_ONLY =
        new CompanionViewContextOld(false, false, false, false, false, false, false, false, 1.25f, 0.175f, purelyVisual:true);

    public static CompanionViewContextOld SHOP_CONTEXT =
        new CompanionViewContextOld(false, true, false, false, true, false, false, true, 0.8f, 0.15f * .75f);

    public static CompanionViewContextOld UNIT_MNGMT_CONTEXT =
        new CompanionViewContextOld(false, false, false, false, true, true, true, false, 1.1f, 0.15f * .6f);

    public static CompanionViewContextOld CARD_SELECTION_CONTEXT =
        new CompanionViewContextOld(false, false, true, true, false, false, false, false, 1.25f, 0.2f);

    public static CompanionViewContextOld COMPENDIUM_CONTEXT =
        new CompanionViewContextOld(false, false, false, true, false, false, false, false, 1.25f, 0.2f);

    public static CompanionViewContextOld COMPANION_UPGRADE_CONTEXT =
        new CompanionViewContextOld(false, false, false, false, true, false, false, true, 0.8f, 0.15f, true);
    ...
    private int index;
    private CompanionViewContextOld context;
    ...
    public CompanionViewOld(
            Companion companion,
            VisualTreeAsset template,
            int index,
            CompanionViewContextOld context,
    ...
    public IEnumerator AbilityActivatedVFX() {
        CompanionViewOld clonedCompanionView = new CompanionViewOld(this.companion, this.template, 0, COMBAT_CONTEXT_VISUAL_ONLY, this.viewDelegate, this.companionInstance);
        yield return EntityAbilityInstance.GenericAbilityTriggeredVFX(this.container, clonedCompanionView.container);
    }
}

public class CompanionViewContextOld {
    ...
    public CompanionViewContextOld(
